...
const Footer = () => {
  ...
  return (
    <section>
      {/* <div className="grid grid-cols-1 gap-y-10 text-end lg:grid-cols-4 bg-primary-blue py-10 text-white "> */}
      <div className="flex flex-col gap-y-6 lg:flex lg:flex-row text-base lg:justify-around bg-primary-blue py-10 text-white text-center lg:text-start">


      <div className="lg:w-4/12  flex flex-col items-center lg:items-start justify-between">

        <Image src="/logo_white.png" width={100} height={100} alt="White MyCash Logo" className=" pb-6 " />
      ...
      <div className="flex flex-col gap-y-4 ">
        ...
        <Image src="/google_app.png" width={100} height={100} alt="google icon" className="m-auto lg:m-0 lg:me-auto"/>
